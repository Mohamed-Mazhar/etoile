...
class AddNewAddressScreen extends StatefulWidget {
  ...
  const AddNewAddressScreen({Key? key, this.isEnableUpdate = false, this.address, this.fromCheckout = false})
      : super(key: key);
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: Theme.of(context).textTheme.displayMedium!.copyWith(
                                    fontSize: Dimensions.fontSizeSmall, color: Colors.green, height: 1),
                              ),
                            )
                          ],
                        )
                      ...
                      : () {
                          ...
                          if (!isAvailable) {
                            ...
                            AddressModel addressModel = AddressModel(
                              addressType:
                                  locationProvider.getAllAddressType[locationProvider.selectAddressIndex],
          ...
          children: [
                ...
                child: Stack(
                  ...
                  children: [
                    GoogleMap(
                      ...
                      onMapCreated: (GoogleMapController controller) {
                        ...
                        if (!widget.isEnableUpdate && _controller != null) {
                          locationProvider.checkPermission((permission) {
                    ...
                    Positioned(
                      ...
                      right: 0,
                      child: InkWell(
                        onTap: () => locationProvider.checkPermission((permission) {
                          if (permission == LocationPermission.always ||
                              permission == LocationPermission.whileInUse) {
                            locationProvider.getCurrentLocation(context, true, mapController: _controller);
                          }
            ...
            Padding(
              ...
              child: Center(
                ...
                style: Theme.of(context).textTheme.displayMedium!.copyWith(
                    color: ColorResources.getGreyBunkerColor(context), fontSize: Dimensions.fontSizeSmall),
              )),
            ),
            Padding(
              ...
              child: Text(
                ...
                style: Theme.of(context).textTheme.displaySmall!.copyWith(
                    color: ColorResources.getGreyBunkerColor(context), fontSize: Dimensions.fontSizeLarge),
              ),
            ),
            SizedBox(
              height: 50,
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => InkWell(
                  ...
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                        vertical: Dimensions.paddingSizeDefault, horizontal: Dimensions.paddingSizeLarge),
