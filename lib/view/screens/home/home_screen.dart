...
class _HomeScreenState extends State<HomeScreen> {
      ...
      (permission) {
        ...
        if (permission == LocationPermission.always || permission == LocationPermission.whileInUse) {
          locationProvider.getCurrentLocation(context, false).then((currentPosition) {
            if (branches != null && splashProvider.splashRepo?.getBranchId() == -1) {
              splashProvider.setUserNearestBranch(
                branches: branches,
          ...
          splashProvider.setDefaultBranch(branches: branches);
        }
      },
      context,
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer:
          ResponsiveHelper.isTab(context) ? const Drawer(child: OptionsView(onTap: null)) : const SizedBox(),
            ...
            delegate: SliverDelegate(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: ColorResources.getSearchBg(context), borderRadius: BorderRadius.circular(10)),
                    child: Row(children: [
                      const Padding(
                          padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                          child: Icon(Icons.search, size: 25)),
                      Expanded(
                          child: Text(getTranslated('search_items_here', context)!,
