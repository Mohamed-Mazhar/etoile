class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _playStoreConfig =
        json['play_store_config'] != null ? PlayStoreConfig.fromJson(json['play_store_config']) : null;
    _appStoreConfig =
        json['app_store_config'] != null ? AppStoreConfig.fromJson(json['app_store_config']) : null;
    ...
    _cookiesManagement =
        json['cookies_management'] != null ? CookiesManagement.fromJson(json['cookies_management']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_socialMediaLink != null) {
      data['social_media_link'] = _socialMediaLink!.map((v) => v.toJson()).toList();
    }
